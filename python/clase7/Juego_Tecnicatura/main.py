...
def main() :
    ...
    texto_mensaje_final = font_small.render(' QUE LA FUERZA TE ACOMPAÑE ', True, (255, 255, 255))

    # Calcular posición para centrar el texto
    pos_x_game_over = SCREEN_WIDTH // 2 - text_game_over.get_width() // 2
    pos_y_game_over = SCREEN_HEIGHT // 2 - text_game_over.get_height() // 2 - 20

    pos_x_mensaje = SCREEN_WIDTH // 2 - texto_mensaje_final.get_width() // 2
    pos_y_mensaje = SCREEN_HEIGHT // 2 + text_game_over.get_height() // 2 + 20

    # Dibujar textos en la pantalla
    screen.blit(text_game_over, (pos_x_game_over, pos_y_game_over))
    screen.blit(texto_mensaje_final, (pos_x_mensaje, pos_y_mensaje))
